...
export const getProductController = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .send({ success: false, error, message: "Error in getting products" });
  }
};
    ...
    switch (true) {
      ...
      case photo && photo.size > 10000000:
        return res.status(500).send({
          error: "Photo is required and it should be less than 1mb"
        });
    }
...
{
  console.log(error)
  res.status(500).send({success:false,message:"Error in filtering products",error})
}
